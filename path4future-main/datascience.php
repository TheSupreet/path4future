  ...
  <body>
      ...
      <main>
            <section id="overview" class="container">
                    <h2>Overview</h2>
                    <p>Welcome to our website. We offer Data Science internship to you. Read on to learn more about our programs and how to apply.</p>
                <section id="programs" class="container">
                  <div class="program">
                    <h3>Data Science Internship</h3>
                    <p>Our Data Science Internship program offers the chance to work on a variety of projects regarding web dwvwlopment. Interns will have the opportunity to learn new technologies and work with a team of experienced developers.</p>
                  </div>
                </section>
